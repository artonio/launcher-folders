...
import csv, os, sys, subprocess, pickle, re
import cairo
import util
...
class MainWindow(Gtk.Window):
	def __init__(self, configFile):
		Gtk.Window.__init__(self, title="Dev")
	...
	# Make the window itself transparent but not the contents
...
class AddNewItemAndReconfigure:
	def __init__(self, configFileName, droppedItemFileName):
		...
		self.writeLog(self.configList, configFileName, droppedItemFileName)
	...
	def writeDekstopFileDrawer(self, settingsList, drawerName, drawerIconFileName, iconSize, drawerType):
		...
		f.write("Exec=" + APP_DIR + "drawer.py " + CONFIG_DIR + drawerName + ".pickle %f" + "\n")
